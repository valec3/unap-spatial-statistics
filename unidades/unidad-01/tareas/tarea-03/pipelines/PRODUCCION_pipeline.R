...
# Configuración
input_pdf <- "unidades/unidad-01/tareas/tarea-03/Input/PRODUCCIÓN DE LECHE.pdf"
output_csv <- "unidades/unidad-01/tareas/tarea-03/data-procesada/PRODUCCION_LIMPIO.csv"
