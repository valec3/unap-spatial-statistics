...
# Configuración
input_pdf <- "unidades/unidad-01/tareas/tarea-03/Input/VACAS PROXIMAS AL PARTO.pdf"
output_csv <- "unidades/unidad-01/tareas/tarea-03/data-procesada/PROXIMAS_PARTO_LIMPIO.csv"
